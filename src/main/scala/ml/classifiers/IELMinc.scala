...
case class IELMinc(seed: Int = 42, notes: String = "", callf: Boolean = false, f: (Model, Double) => Unit = (_, _) => ())
  extends IELMTrait {
  ...
  def update(model: Model, fast_mutable: Boolean)(pattern: Pattern) = {
    ...
    val newTmp = new DenseVector(newE.size)
...
object IELMincTest extends App {
  ...
  val patts0 = new Random(0).shuffle(Datasets.arff(true)("/home/davi/wcs/ucipp/uci/banana.arff").right.get.take(10000))
